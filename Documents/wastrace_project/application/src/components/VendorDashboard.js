...
import { Doughnut, Line, Bar } from "react-chartjs-2"; // keep Bar now
import {
  Chart as ChartJS,
  Title,
  Tooltip,
...
const VendorDashboard = () => {
  ...
  const chartOptions = {
    pie: <Doughnut data={recyclingData} />,
    line: (
      <Line
        data={{
    ...
    volume: <Bar data={volumeChartData} /> // added volume option
  };
      ...
      <div className="dashboard-menu">
        ...
        <div className="menu-item">
          ...
          <select onChange={handleChartChange} value={chartType}>
            ...
            <option value="volume">Volume Chart</option> {/* Correct value */}
          </select>
